...
Repositorio de documentación y evidencia de mi formación en ciberseguridad.
Mentor: CIPHER — Senior Cybersecurity Mentor & Career Coach.
...
| Proyecto | Fase | Bloqueo / Motivo |
|----------|------|-----------------|
| Lab VMs: Kali + Ubuntu + Windows en VirtualBox | F1 | Sin iniciar |
| OverTheWire: Bandit 0–20 | F1 | Sin iniciar |
| Port scanner Python puro | F1 | Sin iniciar |
| Script Bash detección login fallidos | F1 | Sin iniciar |
| Análisis de PCAP con informe | F1 | Sin iniciar |
